...
$cfg['blowfish_secret']					= 'vf,?\\h1.o.`g^n7{Zw*UQ.C#T[#%8`=G' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_oa9q5FURkLJXscGHrOwIf6B/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
